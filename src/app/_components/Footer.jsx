...
function Container({ children }) {
  return (
    <div className="bg-gradient-to-l from-red2 to-red3 h-[60px] border-t border-red5 md:flex  md:justify-center px-2 md:px-0">
      <div className="md:w-9/12 w-full  h-full">{children}</div>
    </div>
  )
}

function MovieDBIcon() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 273.42 35.52"
      className=" -mt-2 inline h-[18px]"
    >
      <defs>
        <linearGradient
          id="a"
